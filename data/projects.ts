...
export const projects: Project[] = [
  {
    ...
    images: {"cover":{"src":img("peak-rescue","cover.jpg"),"alt":"Peak Rescue vest"},"hero":{"src":img("peak-rescue","hero.jpg"),"alt":"Peak Rescue hero"}},
  },
  {
    slug: "herb-tech-cup",
    title: "HerbTech Cup",
    ...
    images: {"cover":{"src":img("herb-tech-cup","cover.jpg"),"alt":"HerbTech Cup"},"hero":{"src":img("herb-tech-cup","hero.jpg"),"alt":"HerbTech Cup hero"}},
  },
  {
    slug: "baby-chair",
    ...
    images: {"cover":{"src":img("baby-chair","cover.jpg"),"alt":"Dingo Baby Seat"},"hero":{"src":img("baby-chair","hero.jpg"),"alt":"Dingo three modes"}},
  },
  {
    ...
    images: {"cover":{"src":img("photographer-exoskeleton","cover.png"),"alt":"HoldLine exoskeleton"},"hero":{"src":img("photographer-exoskeleton","hero.png"),"alt":"HoldLine hero"}},
  },
  {
    slug: "other-works",
    title: "Other Works",
    ...
    images: {"cover":{"src":img("other-works","cover.jpg"),"alt":"Other works"},"hero":{"src":img("other-works","hero.jpg"),"alt":"Other works hero"}},
  },
];
